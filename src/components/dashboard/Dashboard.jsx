...
const Dashboard = () => {
  return (
    <div className='bg-white w-[screen] h-auto overflow overflow-hidden m-4 text-black 
    flex flex-col '>
        <div className='flex flex-col w-full justify-center items-center bg-sky-50 md:flex md:flex-row md:justify-between  '>
        {
            dashboard?.map((item,index)=>(
                
                    <div className='w-[250px] h-auto mb-10 bg-white flex justify-between rounded-md p-3 items-center
                    md:w-[180px]  '>
