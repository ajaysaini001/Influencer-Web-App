...
const MenuBar = ({setOpen,open}) => {
  ...
  return (
    <div className=' sticky top-0'>
       ...
       <Menu.SubMenu key="Hirings" icon={<MdGroups3/>} title="All Hirings">
            <Menu.Item Key="allhirings" icon={<BsThreeDots  size={18} color='skyblue'/>} className='text-xs font-semibold' >All Hirings</Menu.Item>
            <Menu.Item Key="pendings" icon={<BsThreeDots  size={18} color='skyblue'/>} className='text-xs font-bold' >Pendings</Menu.Item>
            <Menu.Item Key="processing" icon={<BsThreeDots  size={18} color='skyblue'/>} className='text-xs font-bold' >Processing</Menu.Item>
            ...
            <Menu.Item Key="canceled" icon={<BsThreeDots  size={18} color='skyblue'/>} className='text-xs font-bold' >Cancelled</Menu.Item>
            
       </Menu.SubMenu> 
       <Menu.SubMenu Key="Orders" icon={<AiOutlineUnorderedList size={16}/>} title="Orders" >
       <Menu.Item Key="allorders" icon={<BsThreeDots  size={18} color='skyblue'/>} className='text-xs font-semibold' >All Orders</Menu.Item>
