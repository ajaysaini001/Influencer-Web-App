...
const Profile = () => {
  return (
    <div className='w-[screen] bg-white m-4' >
        <div className='flex flex-col items-center justify-center m-3 gap-1'>
            ...
            className='w-[50px] h-[50px] rounded-3xl' alt="" />
            <div><span className='font-bold'>Name:</span> <span className='font-sans text-xs'>User name</span></div>
            <div><span className='font-bold'>Email:</span> <span className='font-sans text-xs'>User@gmail.com</span></div>
        ...
        <form className='flex flex-col gap-4 p-3'>
            ...
            <div className='flex flex-col gap-1 w-full'>
                ...
                <input type="text "placeholder='first name' className='border-1  rounded-md h-auto p-2 focus:outline-none focus:border-cyan-200' />
            </div>
            <div className='flex flex-col gap-1 w-full bg-white'>
                <label htmlFor="fname" className='text-xs'>Last Name</label>
                <input type="text "placeholder='last name' className='border-1  rounded-md h-auto p-2 focus:outline-none focus:border-cyan-200' />
            </div>
            </div>
