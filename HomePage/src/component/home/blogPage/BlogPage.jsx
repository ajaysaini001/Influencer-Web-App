...
const BlogPage = () => {
  return (
    <div className=' mt-20 p-10'>
        ...
        <h1 className='text-3xl font-semibold font-sans'>Our Blogs</h1>
        <p className=' w-[400px] font-sans text-center m-auto'>
       Home/Blogs
        </p>
        </div>
        ...
        <div className='mb-10 flex  w-[screen] gap-3 flex-wrap justify-center mt-10'>
            {
                blogs?.map((item,index)=>(
                    <div key={index} className='w-[220px] h-auto p-1 rounded-md flex flex-col gap-2'>
                        {/* <div> */}
                        ...
                        <h2 className='text-xs font-mono font-extrabold' >{item.title}</h2>
                        </div>
